classdef VectorUnitTestsMex < matlab.unittest.TestCase
...
function test_rae2xyz(test)
    ...
    test.verifyEqual(rae2xyz_mex([3; pi/4; 0]), ...
                     3/sqrt(2)*[1; 1; 0], ...
                     'AbsTol', tol);
    
    test.verifyEqual(rae2xyz_mex([5; 0; pi/4]), ...
                     5/sqrt(2)*[1; 0; -1], ...
                     'AbsTol', tol);
    ...
    test.verifyEqual(rae2xyz_mex(rae), v, 'AbsTol', tol);
    
    % Test xyz2rae_mex while we're at it.
    
    test.verifyEqual(xyz2rae_mex(3/sqrt(2)*[1; 1; 0]), ...
                     [3; pi/4; 0], ...
                     'AbsTol', tol);
    
    test.verifyEqual(xyz2rae_mex(5/sqrt(2)*[1; 0; -1]), ...
                     [5; 0; pi/4], ...
                     'AbsTol', tol);
